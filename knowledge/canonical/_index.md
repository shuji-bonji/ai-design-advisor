...
| 次元 | 状態 | ノート |
|------|------|------|
| D1 モデルクラス | canonical | selection.md（社外不可なら D1 が勝つ） |
...
| D4 プロンプト・対話 | canonical | writing → placement（軸が先、その後常駐を痩せる） / ownership / optimization |
...
| D8 セキュリティ | canonical | threat-landscape / permission-vs-authority（誰が承認か） / guardrail-layers / legal-actors |
